...
contract Staking721 is ReentrancyGuard, IStaking721, IERC721Receiver {
    /*///////////////////////////////////////////////////////////////
    ...
    constructor(address _stakingToken, address _rewardToken) ReentrancyGuard() {
        ...
        stakingConditions[0] = StakingCondition({
            timeUnit: 1,
    ...
    function _stake(uint256[] calldata _tokenIds) internal virtual {
        ...
        if (stakers[_stakeMsgSender()].amountStaked > 0) {
            ...
            stakers[_stakeMsgSender()].timeOfLastUpdate = uint128(
                block.timestamp
            );
